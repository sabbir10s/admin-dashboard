    ...
    <div>
      <div className=" space-y-14">
        ...
        <div className="space-y-6">
          ...
          <ButtonFill onClick={openModal}>Off Canvas Sidebar</ButtonFill>
        </div>
      </div>
      <SidebarOffCanvas isOpen={isOpen} onClose={closeModal}>
        <div className="hs-overlay hs-overlay-open:translate-x-0 transition-all duration-300 transform fixed top-0 left-0 bottom-0 z-[60] w-64 bg-white border-r border-gray-200 pt-7 pb-10 overflow-y-auto scrollbar-y translate-x-0 right-auto lg:bottom-0 dark:scrollbar-y dark:bg-gray-800 dark:border-gray-700">
          <div className="px-6">
            <a
