  ...
  return (
    <header>
      <section>
        ...
        placeat dolore quis omnis animi expedita quasi porro sunt voluptas,
        officiis voluptatibus ipsam explicabo commodi tempora mollitia ipsa,
        nihil possimus asperiores. Illum magni natus deleniti accusamus eligendi
        dicta iure alias cupiditate voluptatem. Dolores nam odio quod, iste
        perspiciatis ab nulla! Fugit doloremque laboriosam sunt, vero quos
        consequuntur error odit id officiis dolore magni aperiam officia. Nobis
        expedita laboriosam unde.
      </section>
    </header>
  );
}
