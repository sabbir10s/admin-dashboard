...
const ProductCardThree = ({ productInfo }) => {
    ...
    <div>
      <div className="group border-gray-100/30 flex w-full flex-col self-center overflow-hidden rounded-lg border dark:bg-gray-700 shadow-md">
        ...
        <div className="mt-4 px-5 pb-5">
          <a href="#s">
            <h5 className="text-xl tracking-tight dark:text-white">{name}</h5>
          </a>
          <div className="mt-2 mb-5 flex items-center justify-between">
            <p>
              ...
              <span className="text-sm text-gray-400 dark:text-white line-through">
                ${discount}
              </span>
            </p>
          </div>
          <a
            href="#s"
            className="hover:border-white/40 flex items-center justify-center rounded-md border border-transparent bg-primary-600 px-5 py-2.5 text-center text-sm font-medium text-white focus:outline-none focus:ring-4 focus:ring-primary-300"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
