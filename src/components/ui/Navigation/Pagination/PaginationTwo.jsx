  ...
  return (
    <div className="container mx-auto px-4">
      ...
      >
        ...
        <a
          className="hidden md:flex w-10 h-10 mx-1 justify-center items-center rounded-full border border-primary-600 bg-primary-600 text-white pointer-events-none"
          href="#b"
          aria-current="page"
          title="Page 3"
        >
